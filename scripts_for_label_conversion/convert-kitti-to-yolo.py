...
OUT_LABELS_DIR = "/media/hamed/Data/CV_PRJ/kitti_tracking/data_tracking_label_2/training/label_02/tracking_plus_detection_yolo_format"
...
def parseArguments():
    ...
    parser.add_argument("--training-samples", type=int, default=1, help="percentage of the samples to be used for training between 0.0 and 1.0.")
...
def main():
    args = parseArguments()
    args.label_dir = '/media/hamed/Data/CV_PRJ/kitti_tracking/data_tracking_label_2/training/label_02/tracking_plus_detection'
    args.image_2_dir = '/media/hamed/Data/CV_PRJ/kitti_tracking/data_tracking_image_2/training/image_02/0020'
